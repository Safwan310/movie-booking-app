  ...
  return (
    ...
    <div className={`${mobileState} md:hidden `}>
      <ul className="font-pixelated text-2xl">
        <li className="active"><p className="transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-110 text-center p-1"><Link to="/">Movies</Link></p></li>
        ...
        <div className="flex justify-between md:p-2">
          ...
          <div className="hidden md:flex items-center justify-center space-x-10 font-pixelated text-2xl lg:text-4xl md:text-3xl p-5 sticky top-0">
              <p className="transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-110"><Link to="/">Movies</Link></p>
